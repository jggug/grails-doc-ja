...
'2.12 Creating Artefacts':'2.12 アーティファクトの作成',
'2.10 Supported Java EE Containers':'2.10 サポートされている Java EE コンテナ',
'2.11 Generating an Application':'2.11 アプリケーションの生成',
'2.2 Upgrading from previous versions of Grails':'2.2 Grails下位バージョンからの更新',
'2.3 Creating an Application':'2.3 アプリケーションの作成',
'2.4 A Hello World Example':'2.4 Hello World',
'2.5 Getting Set-up in an IDE':'2.5 IDEの設定',
'2.6 Convention over Configuration':'2.6 設定より規約',
